...
public class AutoSpellingTextArea extends StyledTextArea<Boolean> {
	...
	private autocompleteSpelling.AutoComplete ac;
	private autocompleteSpelling.Dictionary dic;
	private autocompleteSpelling.SpellingSuggest ss;
	...
	public AutoSpellingTextArea(autocompleteSpelling.AutoComplete ac, autocompleteSpelling.SpellingSuggest ss, autocompleteSpelling.Dictionary dic) {
	...
	private void showSuggestions(String word, MouseEvent click) {
		...
		item.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent actionEvent) {
				...
				dic.addWord(word);
				((autocompleteSpelling.Dictionary) ac).addWord(word);
