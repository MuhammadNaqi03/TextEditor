...
public class TextEditorController {
	...
	private void initialize() {
		...
		autocompleteSpelling.Dictionary dic = launch.getDictionary();
	...
	private void handleFleschIndex() {
		...
		if(!text.equals("")) {
			...
			fleschIndex.Document doc = launch.getDocument(text);
	...
	private void handleMarkovText() {
		// get MTG object
		markov.MarkovTextGenerator mtg = launch.getMTG();
		
		Task<markov.MarkovTextGenerator> task = new Task<markov.MarkovTextGenerator>() {
	        @Override
	        public markov.MarkovTextGenerator call() {
	    ...
	    task.setOnSucceeded(e -> {
	    	loadStage.close();
	        markov.MarkovTextGenerator result = task.getValue();
