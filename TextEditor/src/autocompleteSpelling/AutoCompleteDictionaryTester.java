...
public class AutoCompleteDictionaryTester {

	private String dictFile = "data/words.small.txt"; 

	AutoCompleteDictionary emptyDict; 
	AutoCompleteDictionary smallDict;
	AutoCompleteDictionary largeDict;
	

	@Before
	public void setUp() throws Exception 
	{
		emptyDict = new AutoCompleteDictionary();
		smallDict = new AutoCompleteDictionary();
		largeDict = new AutoCompleteDictionary();
	...
	// Tests if the size method is working correctly.
	@Test
